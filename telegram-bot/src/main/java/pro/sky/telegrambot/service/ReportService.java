...
public interface ReportService {
     ...
     * Используется метод репозитория {@link pro.sky.telegrambot.repository.ReportRepository#save(Object)}
     *
     ...
     * Используется метод репозитория {@link pro.sky.telegrambot.repository.ReportRepository#findById(Object)}
     *
     * @param id id отчёта
     * @return Отчёт
     ...
     * Используется метод репозитория {@link pro.sky.telegrambot.repository.ReportRepository#findByReceiveDateAndTrialPeriodId(LocalDate, Long)}
     *
     ...
     * Используется метод репозитория {@link pro.sky.telegrambot.repository.ReportRepository#findAll()}
     *
     ...
     * Используется метод репозитория {@link pro.sky.telegrambot.repository.ReportRepository#findAllByTrialPeriodId(Long)}
     *
     ...
     * {@link TrialPeriodService#update(pro.sky.telegrambot.model.TrialPeriod)}
