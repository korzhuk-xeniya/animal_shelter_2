...
public interface DogService {
     ...
     * @throws pro.sky.telegrambot.exceptions.NotFoundException если собака с указанным идентификатором не найдена в базе данных
     */
    Dog getById(Long id);
     ...
     * @throws pro.sky.telegrambot.exceptions.NotFoundException если собака с хозяином, имеющим указанный идентификатор, не найдена в базе данных
     */
     ...
     * @throws pro.sky.telegrambot.exceptions.NotFoundException если переданный объект собаки не найден в базе данных
     */
    Dog update(Dog dog);
