...
public interface CatService {
     ...
     * @throws pro.sky.telegrambot.exceptions.NotFoundException если кот с указанным идентификатором не найден в базе данных
     */
    Cat getById(Long id);
     ...
     * @throws pro.sky.telegrambot.exceptions.NotFoundException если кот с хозяином, имеющим указанный идентификатор, не найден в базе данных
     */
     ...
     * @throws pro.sky.telegrambot.exceptions.NotFoundException если переданный объект кота не найден в базе данных
     */
    Cat update(Cat cat);
